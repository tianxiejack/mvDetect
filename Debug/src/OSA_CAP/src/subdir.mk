...
src/OSA_CAP/src/%.o: ../src/OSA_CAP/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -D__MV_DETECT_VIBE_=1 -I../include -I../src/OSA_CAP/inc -I/usr/include/opencv -I../src/MovDetector -I../include/VIBE -G -g -O0 -Xcompiler -fPIC -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_20,code=sm_20 -gencode arch=compute_50,code=sm_50 -m64 -odir "src/OSA_CAP/src" -M -o "$(@:%.o=%.d)" "$<"
